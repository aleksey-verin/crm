...
import { ICalls } from '../../../../store/types';
...
const ContentItem = ({ data, allChecked }: ContentItemProps) => {
  const {
    id,
    in_out,
    date,
  ...
  const isChecked = checked ? { opacity: '1' } : {};

  return (
    <div className="content-item">
      <div style={isChecked} className="content-item__checkbox zero">
        <ImgCheckbox handleCheckbox={handleCheckbox} checked={checked} id={String(id)} />
      </div>
